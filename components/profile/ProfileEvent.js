  ...
  return (
    <div className={`Card ${classes.CardEvent}`}>
      <div className="CardContent">
        ...
        {!isLoading ? <button className={classes.deleteEventBtn} onClick={() => handleDelete(id, setIsLoading, setError)}>{L10n[language].delete_event}</button> : <p>{L10n[language].loading}...</p>}
